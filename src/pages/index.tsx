...
Welcome to updated version of the Blogging Platform ([created originally in 2021 using React 17](https://github.com/vadimgierko/blogging-platform))
rewritten from scratch in Next.js, TypeScript & React Bootstrap (in December 2023) for learning & exercise purposes & also for fun & fixing some bugs.
...
If we are talking about non-registered users, like usual readers of blogs, their number is not limited, because articles & blogs are public, so thousands of people can be on site & read articles without a problem.
